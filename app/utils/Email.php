...
class Email {
  ...
  public function SendMail($templateName, $title, $buttonName, $href): bool {
    try {
      $mail = new PHPMailer();
      ...
      if (!file_exists(__DIR__ . "/../views/emails/$templateName.php")) return false;

      include_once __DIR__ . "/../views/emails/$templateName.php";
